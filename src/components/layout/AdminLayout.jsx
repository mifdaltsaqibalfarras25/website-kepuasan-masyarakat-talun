...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans">
      {/* SIDEBAR */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0`}
      >
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-6">
          <Outlet /> {/* Halaman berubah di sini */}
        </div>
      </main>
    </div>
  );
